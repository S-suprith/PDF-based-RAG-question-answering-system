...
def ingest_all_documents(
    ...
    and creates/persists a Chroma vector database.
    ...
    if not pdf_docs:
        print("No PDF documents were loaded. Exiting ingestion.")
        return

    print(f"\nTotal PDF documents loaded: {len(pdf_docs)}")
    ...
    print(
        f"Successfully processed {len(chunked_docs)} "
        f"document chunks and persisted Chroma DB."
    )

    print(
        f"You can now run your application using the data "
